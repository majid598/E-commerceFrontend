...
const ProductCard = ({
  ...
  return <div className="ProductCard w-52 p-5 h-[42vh] flex flex-col items-center justify-start mt-6 relative">
  <div className="flex justify-center items-start w-[100%] h-3/4">
  <img className="w-full h-[22vh] m-[1rem] object-center" src={photo} alt='Mr raju webiste Creater'/>
  </div>
  <Link to={`/product/${productId}`} className="text-2xl leading-6 relative z-[999] hover:underline font-semibold mt-8">{name}</Link>
